...
class Settings(BaseSettings):
    ...
    BOOTSTRAP_ADMIN_ON_STARTUP: bool = os.getenv("BOOTSTRAP_ADMIN_ON_STARTUP", "false").lower() == "true"
    ...
    BOOTSTRAP_ADMIN_FULL_NAME: str = os.getenv("BOOTSTRAP_ADMIN_FULL_NAME", "Administrator")
