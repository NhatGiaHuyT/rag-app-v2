...
from app.startup.admin_bootstrap import bootstrap_admin_from_settings
...
async def startup_event():
    ...
    # Optionally create or update the first admin from environment variables
    bootstrap_admin_from_settings(settings)
